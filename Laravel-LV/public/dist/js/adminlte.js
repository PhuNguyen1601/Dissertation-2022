...
(function (global, factory) {
    ...
    var ControlSidebar = /*#__PURE__*/ (function () {
        ...
        _proto._fixScrollHeight = function _fixScrollHeight() {
            ...
            var navbarFixed =
                ...
                $__default["default"](SELECTOR_HEADER).css("position") ===
                    "fixed";
            var footerFixed =
    ...
    var IFrame = /*#__PURE__*/ (function () {
        ...
        _proto.createTab = function createTab(
            ...
            var navId =
                "tab-" + uniqueName + "-" + Math.floor(Math.random() * 1000);
            var newNavItem =
        ...
        IFrame._jQueryInterface = function _jQueryInterface(operation) {
            ...
            if (
                typeof operation === "string" &&
                operation.match(
                    /createTab|openTabSidebar|switchTab|removeActiveTab/
                )
            ) {
                var _data;
        ...
        _proto.collapse = function collapse() {
            ...
            if (this._options.enableRemember) {
                localStorage.setItem(
                    "remember" + EVENT_KEY$5,
                    CLASS_NAME_COLLAPSED$1
                );
            }
    ...
    var Treeview = /*#__PURE__*/ (function () {
        ...
        _proto.collapse = function collapse(treeviewMenu, parentLi) {
            ...
            parentLi.removeClass(
                CLASS_NAME_IS_OPENING$1 + " " + CLASS_NAME_OPEN$2
            );
            treeviewMenu
                .stop()
